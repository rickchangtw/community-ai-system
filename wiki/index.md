...
type: Index
title: 社區管理知識庫
description: 600 戶社區智慧管理系統 — 統一知識表示 (OKF v0.1)
okf_version: "0.1"
timestamp: 2026-07-19T00:00:00Z
tags: [community, management, 600-residents]
---
...
- [標準作業程序 (SOP)](sop/SOP.md)
- [消防設備管理](fire-equipment/FIRE-EQUIPMENT.md)
- [居民登記簿](residents/RESIDENT-REGISTRY.md)
- [節能管理](energy/ENERGY-MANAGEMENT.md)
- [會議記錄](meetings/MEETING-TEMPLATE.md)
- [系統架構](system/COMMUNITY-SYSTEM.md)
- [連接器配置](connectors/COMMUNITY-CONNECTORS.md)
