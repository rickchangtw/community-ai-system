...
**測試結果**: ✅ GPU Build 成功 / ❌ Server 啟動受限（容器 ioctl）
...
| 模型 | 大小 | 格式 | 來源 |
|------|------|------|------|
| stt_en_citrinet_1024_gamma_0_25.nemo | 484MB | NEMO | `nvidia/stt_en_citrinet_256_ls` |
...
- [x] `tmux` — 失敗
- [x] `setsid` — 失敗
- [x] Python subprocess (start_new_session=True) — 失敗
  ...
  "models": [
    {
      "id": "citrinet-asr",
      "family": "citrinet_asr",
      "path": "/tmp/audio.cpp-models/citrinet/stt_en_citrinet_1024_gamma_0_25.nemo"
    }
  ]
}
```
